...
const Header = () => {
  return (
    <header className="min-h-[calc(100vh-6rem)] w-full flex flex-col justify-center items-center gap-28">
      <Image
      ...
      <div className="space-y-8">
        <div className=" space-y-2 xl:space-y-4 text-center">
          <p className="text-3xl md:text-5xl xl:text-7xl font-semibold">
            WELCOME TO
          </p>
